...
class InteractiveAuthAPI(AuthAPI):
    ...
    def __init__(self, app_id=None, user_login='', user_password='',
                 scope='offline', phone_number=None, api_version=None,
                 **kwargs):
        super(InteractiveAuthAPI, self).__init__(scope=scope,
                                                 phone_number=phone_number,
                                                 api_version=api_version,
                                                 **kwargs)
        self._login = user_login or self.get_user_login()
        self._password = user_password or self.get_user_password()
        self.app_id = app_id or self.get_app_id()
    ...
    def get_2fa_code(self):
        """Command line user input for getting 2fa code
        """
